module "mdb_access_role" {
  source    = "../../modules/role"
  role_name = "${local.project_name}-${var.ENVIRONMENT}-MDBAccessRole-2025-11-08"
...
module "mdb_atlas" {
  ...
  mdb_access_role_arn     = module.mdb_access_role.role_arn

  depends_on = [module.mdb_access_role]
}
